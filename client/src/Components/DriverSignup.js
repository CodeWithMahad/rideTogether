...
export default function DriverSignup() {
  ...
  const handleClick = (event) => {
    ...
    // Create an array containing the form field values
    const formData = [
      firstName,
      lastName,
      age,
    ...
    // Navigate to DriverHome or perform any other necessary action
    navigate('/DriverHome');
  }
            ...
            <div className="card my-5 ms-3" style={{ borderRadius: '30px' }}>
              <div className="card-body my-3">
                <form>
                  ...
                  <div className="mb-3 text-center">
                    <label htmlFor="licensePic" className="form-label">License Picture</label>
                  ...
                  <div className="text-center mt-3">
                    <button type="submit" className="btn text-white btn-lg px-5" style={{ backgroundColor: '#091F5B' }} onClick={handleClick}>Signup</button>
                  </div>
                </form>
              </div>
            </div>
